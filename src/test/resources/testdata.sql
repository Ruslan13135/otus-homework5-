...
-- книги
insert into book (id, title, genreId, authorId) values (1, 'Игра престолов', 1, 1)
insert into book (id, title, genreId, authorId) values (2, 'Девять принцев Амбера', 2, 2)
insert into book (id, title, genreId, authorId) values (3, 'Война и мир', 3, 3)